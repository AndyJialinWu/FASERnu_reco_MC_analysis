...
// Sun Mar  9 18:59:55 2025 by ROOT version 6.32.04
// from TTree disc200025_TrainTest/disc200025_TrainTest
// found on file: PhysicsNTUP_ML_runnumber.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   std::vector<int>     *MaxGap;
   std::vector<double>  *theta_RMS;
   std::vector<double>  *MaxKinkAngle;
   std::vector<bool>    *IsPartCatChanged;
   std::vector<bool>    *IsTrkIdChanged;
   Float_t         n_ch;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("PhysicsNTUP_ML_runnumber.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("PhysicsNTUP_ML_runnumber.root");
      }
      f->GetObject("disc200025_TrainTest",tree);
