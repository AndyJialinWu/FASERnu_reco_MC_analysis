...
void TMVAClassification(TString inputFileName, TString outputFileName){
   ...
   TMVA::Tools::Instance();
    ...
    TTree *signalTree = (TTree*)f_PhysicsNTUP_ML->Get("discNC_TrainTest");
    TTree *background = (TTree*)f_PhysicsNTUP_ML->Get("discBkg_TrainTest");
    ...
    factory->BookMethod( dataloader, TMVA::Types::kBDT, "BDTG",
                        "!H:!V:NTrees=1000:MinNodeSize=2.5%:BoostType=Grad:Shrinkage=0.10:UseBaggedBoost:BaggedSampleFraction=0.5:nCuts=20:MaxDepth=100" );
