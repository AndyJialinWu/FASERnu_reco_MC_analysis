...
// Sat Apr  5 20:25:19 2025 by ROOT version 6.32.08
// from TTree disc_RealData/disc_RealData
// found on file: PhysicsNTUP_ML_SimonThor.root
//////////////////////////////////////////////////////////

#ifndef PhysicsNTUP_h
#define PhysicsNTUP_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         n_ch;
   Float_t         nTrkTanThetaLeq0point1_reco;
   Float_t         nTrkTanThetaLeq0point1_true;
   ...
   TBranch        *b_n_ch;   //!
   TBranch        *b_nTrkTanThetaLeq0point1_reco;   //!
   TBranch        *b_nTrkTanThetaLeq0point1_true;   //!
...
#ifdef PhysicsNTUP_cxx
PhysicsNTUP::PhysicsNTUP(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("PhysicsNTUP_ML_SimonThor.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("PhysicsNTUP_ML_SimonThor.root");
      }
      f->GetObject("disc_RealData",tree);

   }
   Init(tree);
}

PhysicsNTUP::~PhysicsNTUP()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t PhysicsNTUP::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PhysicsNTUP::LoadTree(Long64_t entry)
{
...
void PhysicsNTUP::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("nTrkTanThetaLeq0point1_reco", &nTrkTanThetaLeq0point1_reco, &b_nTrkTanThetaLeq0point1_reco);
   fChain->SetBranchAddress("nTrkTanThetaLeq0point1_true", &nTrkTanThetaLeq0point1_true, &b_nTrkTanThetaLeq0point1_true);
...
void PhysicsNTUP::Show(Long64_t entry)
{
...
Int_t PhysicsNTUP::Cut(Long64_t entry)
{
