...
// Tue Jan 21 12:42:55 2025 by ROOT version 6.32.04
// from TTree tracks/tracks
// found on file: /home/jialwu/raid/FASERnu_MC_reco/NC/200025/evt_7_pl114_214/linked_tracks.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxs = 79;
   static constexpr Int_t kMaxsf = 79;
 ...
 //EdbSegP         *s_EdbTrack2D;
   ...
   Int_t           s_eTrack[kMaxs];   //[s_] MC track ID
   ...
   Float_t         s_eP[kMaxs];   //[s_] MC truth momentum 
   Int_t           s_eMCTrack[kMaxs];   //[s_] PDG code
   Int_t           s_eMCEvt[kMaxs];   //[s_] MC event ID + 100000
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/jialwu/raid/FASERnu_MC_reco/NC/200025/evt_7_pl114_214/linked_tracks.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/jialwu/raid/FASERnu_MC_reco/NC/200025/evt_7_pl114_214/linked_tracks.root");
      }
...
void tracks::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("s.eTrack", s_eTrack, &b_s_eTrack); // track ID
   ...
   fChain->SetBranchAddress("s.eP", s_eP, &b_s_eP);   // true momentum magnitude
   fChain->SetBranchAddress("s.eMCTrack", s_eMCTrack, &b_s_eMCTrack); // segment PDG code
   fChain->SetBranchAddress("s.eMCEvt", s_eMCEvt, &b_s_eMCEvt); // event ID + 1000 000
   ...
   fChain->SetBranchAddress("sf.eTrack", sf_eTrack, &b_sf_eTrack); // segment Track ID
