...
void ana_linked_tracks(tracks *linked_tracks, float vx_hit, float vy_hit, float vz_hit,
                       ...
                       std::vector<int> &nseg, std::vector<float> &pmag_MCtruth, std::vector<double> &ImpactParameter){
...
void sort_linked_tracks(std::vector<int> &trackID, std::vector<double> &tan_theta, std::vector<double> &phi_angle, 
    ...
    std::vector<float> sorted_pmag(pmag.size());
    for (size_t i = 0; i < indices.size(); ++i) {
...
//        std::cout<<__LINE__<<std::endl;
        ana_linked_tracks(linked_tracks, vx_hit, vy_hit, vz_hit, trackID[0], n_ch[0], tan_theta[0], phi_angle[0], nseg, pmag_MCtruth, ImpactParameter);
//        std::cout<<__LINE__<<std::endl;
        sort_linked_tracks(trackID[0], tan_theta[0], phi_angle[0], nseg, pmag_MCtruth, ImpactParameter);
//        std::cout<<__LINE__<<std::endl;
