...
*/              
        ...
        h1_dphi_max_deg[0]->Fill(disc->dphi_max_reco);
        h1_dphi_max_deg[1]->Fill(disc->dphi_max_true);
        
        h1_dphi_sum_deg[0]->Fill(disc->dphi_sum_reco);
        h1_dphi_sum_deg[1]->Fill(disc->dphi_sum_true);

        h1_DeltaPhiMET_deg[0]->Fill(disc->DeltaPhiMET_reco);
        h1_DeltaPhiMET_deg[1]->Fill(disc->DeltaPhiMET_true);

        h1_pmag_had_vis[0]->Fill(disc->pmag_had_vis_reco);
        h1_pmag_had_vis[1]->Fill(disc->pmag_had_vis_true);

        h1_p_had_hardest[0]->Fill(disc->p3_hardest_reco);
        h1_p_had_hardest[1]->Fill(disc->p3_hardest_true);

        h1_pTmiss_mag[0]->Fill(disc->pTmiss_mag_reco);
        h1_pTmiss_mag[1]->Fill(disc->pTmiss_mag_true);
        
        h1_pTabs_sum[0]->Fill(disc->pTabs_sum_reco);
        h1_pTabs_sum[1]->Fill(disc->pTabs_sum_true);

        h1_InvThetaCh[0]->Fill(disc->InvThetaCh_reco);
        h1_InvThetaCh[1]->Fill(disc->InvThetaCh_true);

        h1_tan_theta_hardest[0]->Fill(disc->tan_theta_hardest_reco);
        h1_tan_theta_hardest[1]->Fill(disc->tan_theta_hardest_true);
